...
export const info = `<Alert look="success">
  <strong>Well done!</strong> You successfully read this important alert message. Lorem ipsum
  dolor sit amet, consectetur adipisicing elit. <a href="#">Link</a>
</Alert>`;

export const warning = `<Alert look="warning">
  <strong>Warning!</strong> Better check yourself, you’re not looking too good.{' '}
  <a href="#">Link</a>
</Alert>`;

export const danger = `<Alert look="danger">
  <strong>Oh snap!</strong> Change a few things up and try submitting again.{' '}
  <a href="#">Link</a>
</Alert>`;

export const system = `<Alert look="system">
