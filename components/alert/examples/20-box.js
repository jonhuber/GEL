...
export default () => (
	<>
		<Alert appearance="success" icon={InfoIcon}>
		...
		<Alert appearance="information" icon={InfoIcon}>
			<strong>Heads up!</strong> This alert needs your attention, but it’s not super important.{' '}
			<a href="#">Link</a>
		</Alert>
		<Alert appearance="warning" icon={InfoIcon}>
			<strong>Warning!</strong> Better check yourself, you’re not looking too good.{' '}
			<a href="#">Link</a>
		</Alert>
		<Alert appearance="danger" icon={InfoIcon}>
			<strong>Oh snap!</strong> Change a few things up and try submitting again.{' '}
			<a href="#">Link</a>
		</Alert>
		<Alert appearance="system" icon={InfoIcon}>
